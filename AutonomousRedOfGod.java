...
/**
 * Created by famil on 1/17/2017.
 */
@Autonomous(name="Red Dragon", group="Red")
@Disabled
public class AutonomousRedOfGod extends LinearOpMode {
    ...
    static final double WHITE_THRESHOLD = .15 ;
